...
public class MainActivity extends AppCompatActivity {
    ...
    public void onRadioButtonClicked(View view) {
        ...
        if (score > 0) {
            Toast.makeText(MainActivity.this, nesta, Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(MainActivity.this, "Moras odabrati barem jedno pitanje", Toast.LENGTH_LONG).show();
        }
    }
